...
public class WaitForStepCompletionTasklet implements Tasklet {
    @Override
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        final DescribeStepRequest stepRequest = new DescribeStepRequest().withStepId(stepId).withClusterId(clusterId);
        emrClient.waiters().stepComplete().run(new WaiterParameters<>(stepRequest));
